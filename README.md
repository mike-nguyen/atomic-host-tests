...
Fedora 29 Atomic Host | ![fedora 29 atomic status](https://s3.amazonaws.com/aos-ci/atomic-host-tests/improved-sanity-test/fedora-29-atomic/latest/status.png) | [log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/improved-sanity-test/fedora-29-atomic/latest/improved-sanity-test.log)| [pkgs](https://s3.amazonaws.com/aos-ci/atomic-host-tests/improved-sanity-test/fedora-29-atomic/latest/pkg-list)
Fedora 29 Atomic Testing | ![fedora 29 atomic testing status](https://s3.amazonaws.com/aos-ci/atomic-host-tests/improved-sanity-test/fedora-29-atomic-testing/latest/status.png) | [log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/improved-sanity-test/fedora-29-atomic-testing/latest/improved-sanity-test.log)| [pkgs](https://s3.amazonaws.com/aos-ci/atomic-host-tests/improved-sanity-test/fedora-29-atomic-testing/latest/pkg-list)
Fedora 29 Atomic Updates| ![fedora 29 atomic updates status](https://s3.amazonaws.com/aos-ci/atomic-host-tests/improved-sanity-test/fedora-29-atomic-updates/latest/status.png) | [log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/improved-sanity-test/fedora-29-atomic-updates/latest/improved-sanity-test.log)| [pkgs](https://s3.amazonaws.com/aos-ci/atomic-host-tests/improved-sanity-test/fedora-29-atomic-updates/latest/pkg-list)
...
| docker-build-httpd | [![docker-build-httpd log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/docker-build-httpd/fedora-28-atomic-updates/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/docker-build-httpd/fedora-28-atomic-updates/latest/docker-build-httpd.log) | docker-build-http | [![docker-build-httpd log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/docker-build-httpd/fedora-28-atomic-testing/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/docker-build-httpd/fedora-28-atomic-testing/latest/docker-build-httpd.log) |
...
|||||
| **Fedora 29 Atomic** | **Result** | **Fedora 29 Atomic Updates** | **Result** |
| admin-unlock | [![admin-unlock log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/admin-unlock/fedora-29-atomic/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/admin-unlock/fedora-29-atomic/latest/admin-unlock.log) | admin-unlock | [![admin-unlock log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/admin-unlock/fedora-29-atomic-updates/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/admin-unlock/fedora-29-atomic-updates/latest/admin-unlock.log) |
| atomic | [![atomic log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/atomic/fedora-29-atomic/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/atomic/fedora-29-atomic/latest/atomic.log) | atomic | [![atomic log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/atomic/fedora-29-atomic-updates/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/atomic/fedora-29-atomic-updates/latest/atomic.log) |
| docker | [![docker log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/docker/fedora-29-atomic/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/docker/fedora-29-atomic/latest/docker.log) | docker | [![docker log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/docker/fedora-29-atomic-updates/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/docker/fedora-29-atomic-updates/latest/docker.log) |
| docker-build-httpd | [![docker-build-httpd log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/docker-build-httpd/fedora-29-atomic/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/docker-build-httpd/fedora-29-atomic/latest/docker-build-httpd.log) | docker-build-http | [![docker-build-httpd log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/docker-build-httpd/fedora-29-atomic-updates/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/docker-build-httpd/fedora-29-atomic-updates/latest/docker-build-httpd.log) |
| docker-swarm | [![docker-swarm log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/docker-swarm/fedora-29-atomic/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/docker-swarm/fedora-29-atomic/latest/docker-swarm.log) | docker-swarm | [![docker-swarm log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/docker-swarm/fedora-29-atomic-updates/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/docker-swarm/fedora-29-atomic-updates/latest/docker-swarm.log) |
| k8-cluster | [![k8-cluster log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/k8-cluster/fedora-29-atomic/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/k8-cluster/fedora-29-atomic/latest/k8-cluster.log) | k8-cluster | [![k8-cluster log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/k8-cluster/fedora-29-atomic-updates/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/k8-cluster/fedora-29-atomic-updates/latest/k8-cluster.log) |
| oc-cluster-up | [![oc-cluster-up log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/oc-cluster-up/fedora-29-atomic/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/oc-cluster-up/fedora-29-atomic/latest/oc-cluster-up.log) | oc-cluster-up | [![oc-cluster-up log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/oc-cluster-up/fedora-29-atomic-updates/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/oc-cluster-up/fedora-29-atomic-updates/latest/oc-cluster-up.log) |
| pkg-layering | [![pkg-layering](https://s3.amazonaws.com/aos-ci/atomic-host-tests/pkg-layering/fedora-29-atomic/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/pkg-layering/fedora-29-atomic/latest/pkg-layering.log) | pkg-layering | [![pkg-layering](https://s3.amazonaws.com/aos-ci/atomic-host-tests/pkg-layering/fedora-29-atomic-updates/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/pkg-layering/fedora-29-atomic-updates/latest/pkg-layering.log) |
| rpm-ostree | [![rpm-ostree log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/rpm-ostree/fedora-29-atomic/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/rpm-ostree/fedora-29-atomic/latest/rpm-ostree.log) | rpm-ostree | [![rpm-ostree log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/rpm-ostree/fedora-29-atomic-updates/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/rpm-ostree/fedora-29-atomic-updates/latest/rpm-ostree.log) |
| system-containers | [![system-containers log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/system-containers/fedora-29-atomic/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/system-containers/fedora-29-atomic/latest/system-containers.log) | system-containers | [![system-containers log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/system-containers/fedora-29-atomic-updates/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/system-containers/fedora-29-atomic-updates/latest/system-containers.log) |
|||||
| **Fedora 29 Atomic Testing** | **Result** | **Fedora Rawhide Atomic Host** | **Result** |
| admin-unlock | [![admin-unlock log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/admin-unlock/fedora-29-atomic-testing/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/admin-unlock/fedora-29-atomic-testing/latest/admin-unlock.log) | admin-unlock | [![admin-unlock log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/admin-unlock/fedora-rawhide/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/admin-unlock/fedora-rawhide/latest/admin-unlock.log) |
| atomic | [![atomic log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/atomic/fedora-29-atomic-testing/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/atomic/fedora-29-atomic-testing/latest/atomic.log) | atomic | [![atomic log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/atomic/fedora-rawhide/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/atomic/fedora-rawhide/latest/atomic.log) |
| docker | [![docker log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/docker/fedora-29-atomic-testing/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/docker/fedora-29-atomic-testing/latest/docker.log) | docker | [![docker log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/docker/fedora-rawhide/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/docker/fedora-rawhide/latest/docker.log) |
| docker-build-httpd | [![docker-build-httpd log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/docker-build-httpd/fedora-29-atomic-testing/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/docker-build-httpd/fedora-29-atomic-testing/latest/docker-build-httpd.log) | docker-build-httpd | [![docker-build-httpd log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/docker-build-httpd/fedora-rawhide/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/docker-build-httpd/fedora-rawhide/latest/docker-build-httpd.log) |
| docker-swarm | [![docker-swarm log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/docker-swarm/fedora-29-atomic-testing/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/docker-swarm/fedora-29-atomic-testing/latest/docker-swarm.log) | docker-swarm | [![docker-swarm log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/docker-swarm/fedora-rawhide/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/docker-swarm/fedora-rawhide/latest/docker-swarm.log) |
| k8-cluster | [![k8-cluster log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/k8-cluster/fedora-29-atomic-testing/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/k8-cluster/fedora-29-atomic-testing/latest/k8-cluster.log) | k8-cluster | [![k8-cluster log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/k8-cluster/fedora-rawhide/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/k8-cluster/fedora-rawhide/latest/k8-cluster.log) |
| oc-cluster-up | [![oc-cluster-up log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/oc-cluster-up/fedora-29-atomic-testing/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/oc-cluster-up/fedora-29-atomic-testing/latest/oc-cluster-up.log) | oc-cluster-up | [![oc-cluster-up log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/oc-cluster-up/fedora-rawhide/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/oc-cluster-up/fedora-rawhide/latest/oc-cluster-up.log) |
| pkg-layering | [![pkg-layering](https://s3.amazonaws.com/aos-ci/atomic-host-tests/pkg-layering/fedora-29-atomic-testing/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/pkg-layering/fedora-29-atomic-testing/latest/pkg-layering.log) | pkg-layering | [![pkg-layering](https://s3.amazonaws.com/aos-ci/atomic-host-tests/pkg-layering/fedora-rawhide/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/pkg-layering/fedora-rawhide/latest/pkg-layering.log) |
| rpm-ostree | [![rpm-ostree log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/rpm-ostree/fedora-29-atomic-testing/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/rpm-ostree/fedora-29-atomic-testing/latest/rpm-ostree.log) | rpm-ostree | [![rpm-ostree log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/rpm-ostree/fedora-rawhide/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/rpm-ostree/fedora-rawhide/latest/rpm-ostree.log) |
| system-containers | [![system-containers log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/system-containers/fedora-29-atomic-testing/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/system-containers/fedora-29-atomic-testing/latest/system-containers.log) | system-containers | [![system-containers log](https://s3.amazonaws.com/aos-ci/atomic-host-tests/system-containers/fedora-rawhide/latest/status.png)](https://s3.amazonaws.com/aos-ci/atomic-host-tests/system-containers/fedora-rawhide/latest/system-containers.log) |
